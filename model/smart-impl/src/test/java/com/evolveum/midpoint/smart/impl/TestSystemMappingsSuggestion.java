...
public class TestSystemMappingsSuggestion extends AbstractSmartIntegrationTest {
    ...
    public void test120DeduplicationAgainstAcceptedSuggestion() throws Exception {
        ...
        var acceptedDefinition = new ResourceAttributeDefinitionType();
        acceptedDefinition.ref(new ItemPathType(TELEPHONE_NUMBER.path()));
        ...
        acceptedDefinition.getInbound().add(inbound);

        var interactionMetadata = new MappingsSuggestionInteractionMetadataType();
        interactionMetadata.getAcceptedAttributeMappingsSuggestion().add(acceptedDefinition);
