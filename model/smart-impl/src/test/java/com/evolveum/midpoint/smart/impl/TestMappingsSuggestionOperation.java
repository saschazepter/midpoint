...
public class TestMappingsSuggestionOperation extends AbstractSmartIntegrationTest {
    ...
    public void test001AsIsMappingWhenDataIdentical() throws Exception {
        ...
        var ownedShadows = smartIntegrationService.sampleOwnedShadows(RESOURCE_DUMMY.oid, ACCOUNT_DEFAULT, 20, task, result);
        MappingsSuggestionType suggestion = op.suggestMappings(result, statistics, match, ownedShadows);
