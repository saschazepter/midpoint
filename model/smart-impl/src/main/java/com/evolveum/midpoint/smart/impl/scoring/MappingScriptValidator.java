...
public class MappingScriptValidator {
    ...
    public void testMappingScript(
        ...
        try {
            String valueToTest = testValue != null ? testValue : "test";
            executeScript(expression, variableName, valueToTest, task, result);
    ...
    /**
     * Executes the mapping script with the provided test value.
     */
    private void executeScript(
        ...
        final String description = "Mapping script validation";
        final VariablesMap variables = new VariablesMap();
        variables.put(variableName, testValue, String.class);
