...
public class ProjectionValuesProcessor implements ProjectorProcessor {
    ...
    private <F extends ObjectType> String formatIterationToken(
        ...
        if (iterationSpec.getTokenExpression() == null) {
            int start = LensUtil.determineIterationStart(iterationSpec);
            return LensUtil.formatIterationTokenDefault(iteration, start);
        }
